			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="variety/list.do" method="post" name="Form" id="Form">
						<table style="margin-top:5px;">
							<tr>
								<td>
									<div class="nav-search">
										<span class="input-icon">
											<input type="text" placeholder="这里输入菜品名称" class="nav-search-input" id="nav-search-input" autocomplete="off" name="keywords" value="${pd.NAME }" placeholder="这里输入菜品名称"/>
								...
								<c:when test="${not empty varList}">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											...
											<td class='center'>${var.COLUMN_ID}</td>
										<%--	<td class='center'>${var.UPDATE_TIME}</td>--%>
											<td class='center'>${var.PRICE}</td>
											<td class='center'>
												<img src="<%=basePath%>uploadFiles/uploadImgs/${var.IMAGE}" alt="${var.NAME}" width="100">
											...
											<td class="center">
												...
												<div class="hidden-sm hidden-xs btn-group">
													<c:if test="${QX.edit == 1 }">
													<a class="btn btn-xs btn-success" title="编辑" onclick="edit('${var.VARIETY_ID}');">
												...
												<div class="hidden-md hidden-lg">
													<div class="inline pos-rel">
														...
														<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
															<c:if test="${QX.edit == 1 }">
															<li>
																<a style="cursor:pointer;" onclick="edit('${var.VARIETY_ID}');" class="tooltip-success" data-rel="tooltip" title="修改">
																	<span class="green">
															...
															<c:if test="${QX.del == 1 }">
															<li>
																<a style="cursor:pointer;" onclick="del('${var.VARIETY_ID}');" class="tooltip-error" data-rel="tooltip" title="删除">
																	<span class="red">
...
/*			 top.jzts();*/
			 ...
			 diag.Drag=true;
			 diag.Title ="新增";
			 diag.URL = '<%=basePath%>variety/goAdd.do';
			 diag.Width = 450;
			 diag.Height = 355;
		...
		function edit(Id){
			/* top.jzts();*/
			 ...
			 diag.Drag=true;
			 diag.Title ="编辑";
			 diag.URL = '<%=basePath%>variety/goEdit.do?VARIETY_ID='+Id;
			 diag.Width = 450;
			 diag.Height = 355;
			 diag.Modal = true;				//有无遮罩窗口
			 diag.ShowMaxButton = true;	//最大化按钮
		...
		//导出excel
		function toExcel(){
			window.location.href='<%=basePath%>variety/excel.do';
		}
	</script>
